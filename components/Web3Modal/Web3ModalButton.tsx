...
export default function ConnectButton() {
    ...
    return (
        <div onClick={() => open()} className="rounded-full bg-primary/90 cursor-pointer transition-all hover:bg-primary/100 px-3 py-2 flex items-center justify-center cursor-pointer">
