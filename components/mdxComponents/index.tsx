...
// Extend the HTMLAttributes type to include 'data-language'
interface CodeProps extends HTMLAttributes<HTMLElement> {
  "data-language"?: string; // Define the custom property
}
...
export const customMDXComponents: MDXComponents = {
  ...
  code: ({ className, "data-language": dataLanguage, ...props }: CodeProps) => {
    ...
    const languageProp = Boolean(dataLanguage) || languageClassExist;
    return (
      <code
        className={cn(
          className,
