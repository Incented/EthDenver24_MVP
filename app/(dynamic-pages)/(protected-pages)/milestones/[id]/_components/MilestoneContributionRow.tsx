...
import { getValidationsForMilestoneContribution } from "@/data/user/milestones";
import { getContributionAndUserProfile } from "@/data/user/tasks";
...
import ValidateSheet from "./MilestoneValidateSheet";

interface MilestoneContributionRowProps {
  contribution: Table<"grant_project_milestones_contributions">;
  allContributions: Table<"grant_project_milestones_contributions">[];
  loggedInUser: string;
}
const MilestoneContributionRow: FC<MilestoneContributionRowProps> = async ({
  contribution,
  allContributions,
  loggedInUser,
}) => {
  ...
  const [contributorProfile, validationsForContribution] = await Promise.all([
    ...
    getValidationsForMilestoneContribution(contribution.id),
  ]);
    ...
    <TableRow>
      ...
      <TableCell className="text-center">
        <div className="flex justify-center space-x-2">
          ...
          <ValidateSheet contribution={contribution} contributorProfile={contributorProfile}
...
export default MilestoneContributionRow;
