...
export function MilestoneValidationCard(detail: { full_name: string | null; avatar_url: string | null; count: number; created_at: string; user_id: string; }) {
        ...
        <div className="py-4 border-b flex gap-3 items-center w-full">
            ...
            <div>
                ...
                <div className="flex gap-2 items-center text-sm text-muted-foreground">
                    ...
                    </svg> : <div className="relative size-5"><Image src='/images/arb.svg' alt="ARB" fill /></div>}
                    {position} </div>
            </div>
        </div>
    );
