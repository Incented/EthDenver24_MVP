...
import { validateMilestoneContributionAction } from "@/data/user/milestones";
...
import { AttachmentType, FilePreview } from "../../../dashboard/tasks/create-task/components/CreateTaskFormTypes";
import { UploadFiles } from "../../../dashboard/tasks/create-task/components/uploadFile";
...
interface MilestoneValidateSheetProps {
...
const MilestoneValidateSheet: FC<MilestoneValidateSheetProps> = ({ contribution, contributorProfile, loggedInUser }) => {
  ...
  const { mutate } = useToastMutation(
    async (data: ValidationFormSchema) => {
      ...
      return await validateMilestoneContributionAction({
        contribution_id: contribution.id,
        description,
        milestone_id: contribution.grant_project_milestone_id,
        count,
        files,
      });
    },
    {
      ...
      onSuccess: (data) => {
        router.push(`/milestones/${contribution.grant_project_milestone_id}`);
        ...
        <Card className="p-3 my-4">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            <div className="space-y-1">
              <Label className="text-sm leading-[14px]">Amount of ARBs'</Label>
...
export default MilestoneValidateSheet;
