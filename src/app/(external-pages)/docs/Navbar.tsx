...
import lightLogo from '@public/logos/ico_orange.svg';
import darkLogo from '@public/logos/ico_orange.svg';
        ...
        <div className=" flex items-center">
          <Link href={'/'} className={classNames('font-bold text-xl ')}>
            <div className="relative flex space-x-2 items-center text-black dark:text-white dark:-ml-4">
              ...
              />
              <span className="hidden font-bold sm:inline-block">Incented</span>
            </div>
          </Link>
        </div>
