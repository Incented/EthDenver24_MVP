...
export function ExternalNavigation() {
  ...
  const navigation: Array<{
    ...
    const nav = [
      { name: 'Docs', href: 'http://protocol.incented.co', target: '_blank' },
      { name: 'Blog', href: 'https://blog.incented.co/', target: '_blank' },
      // { name: 'Changelog', href: '/changelog', target: '',},
          ...
          >
            <div className="relative flex space-x-2 w-10 h-10 md:w-fit items-center justify-center text-black dark:text-white dark:-ml-4 -ml-2">
              ...
              <Image
                ...
                height={40}
                alt="logo"
                className="dark:invert hidden dark:block h-8 w-8"
              />
              <span className="dark:invert hidden font-bold lg:inline-block text-black">
                Incented
              </span>
            </div>
          </Link>
