          ...
          <div className="flex gap-2 justify-start items-center">
            <div>
              <div className="flex gap-3 items-center">
                <T.H3 className="mt-0">Tasks</T.H3>{' '}
                <Dialog>
                  ...
                  <DialogContent className="w-128 dark:bg-slate-900 bg-white border border-gray-300 dark:border-gray-700">
                    ...
                    <T.P className="text-muted-foreground">
                      Tasks are the core element in Incented. Create a task proposal for anything that
                      needs to be done in your community. 
                    </T.P>
                  </DialogContent>
                </Dialog>
              </div>
              <T.P className="text-muted-foreground leading-6">
                You can create tasks within teams, or within your
                Rabbit Hole globally.
              </T.P>
            </div>
          </div>
