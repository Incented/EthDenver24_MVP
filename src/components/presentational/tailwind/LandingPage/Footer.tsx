...
const Footer = () => {
  return (
    <footer className="p-4 bg-gray-50 sm:p-6 dark:bg-slate-800">
      <div className="mx-auto md:container pt-2 md:pt-4">
        <div className="md:flex md:justify-between pb-2 md:pb-4">
          <div className="mb-6 md:mb-0">
            <a href="/" className="flex items-center">
              ...
              <Image
                src={logo}
                className="invert mr-3 h-8 hidden dark:block"
                width={32}
                height={32}
                alt="Incented Logo"
              />
            ...
            {/* <div className="mt-4 space-x-4 pt-4 border-t dark:border-slate-700 ">
                            <a
                                href="https://discord.gg/STSwdhRA"
